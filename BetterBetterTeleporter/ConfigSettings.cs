...
public static class ConfigSettings
{
    ...
    public static ConfigEntry<int> BatteryDrainPercentEntry { get; private set; }
    ...
    public static void Init(ConfigFile config)
    {
        ...
        BatteryDrainPercentEntry = config.Bind("Inverse Teleporter", "BatteryDrainPercent", 0, new ConfigDescription("Drains all held battery items by a percentage when using the Inverse Teleporter. (0 to disable.)", new AcceptableValueRange<int>(0, 100)));
